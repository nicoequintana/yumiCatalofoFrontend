...
function CarruselDestacados({ productos }) {
  ...
  return (
    <section className="w-full bg-surface-container-lowest">
      {/* `pt-7 md:pt-12`: el mismo ritmo vertical que las demás secciones de
          la home (mockup `.seccion`, 28/48 px). */}
      <div className="mx-auto w-full max-w-container-max px-margin-mobile pt-7 md:px-margin-desktop md:pt-12">
