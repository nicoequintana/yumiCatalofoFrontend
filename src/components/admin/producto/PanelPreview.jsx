 ...
 *
 * Cada columna scrollea por su cuenta (`lg:overflow-y-auto`) en vez de usar
 * `position: sticky`: el `<main>` de `AdminLayout` lleva `overflow-x-auto` por
 * las tablas anchas del admin, lo que lo convertiría en el scrollport del
 * sticky mientras quien scrollea es la ventana.
 */
