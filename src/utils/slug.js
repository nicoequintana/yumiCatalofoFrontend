 ...
 *
 * SYNC MANUAL con `backend/src/lib/slug.js`: los dos repos se publican por
 * separado, así que no hay forma de compartir el módulo. Mismo trade-off
 * documentado que `botDetector.js` <-> `nginx.conf`. Los dos archivos de test
 * tienen el MISMO set de casos: al tocar una copia, tocar la otra.
 */
