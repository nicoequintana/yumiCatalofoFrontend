              ...
              <tr role="row" className="border-b border-outline-variant">
                <th role="columnheader" className="px-2 py-2 xl:px-3 xl:py-3">
                  {/* El `<label>` amplía el área táctil a ~44px con un margen
                      ...
                      el checkbox seguía siendo un control real, así que el foco
                      de teclado caía en un elemento de 1px invisible y el dedo
                      no tenía dónde tocarlo. `hidden` lo saca del orden de
